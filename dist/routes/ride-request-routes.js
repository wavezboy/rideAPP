...
const rideRequestController = __importStar(require("../controller/rideRequest-controller"));
...
router.post("/cancel-ride-request/:requestId", rideRequestController.cancelRideRequest);
